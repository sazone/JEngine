...
{
    unsafe class VEngine_Loadable_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(VEngine.Loadable);
            args = new Type[]{};
        ...
        static StackObject* get_isDone_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            VEngine.Loadable instance_of_this_method = (VEngine.Loadable)typeof(VEngine.Loadable).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
