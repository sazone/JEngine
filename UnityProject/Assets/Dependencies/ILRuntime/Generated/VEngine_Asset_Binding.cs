...
namespace ILRuntime.Runtime.Generated
{
    unsafe class VEngine_Asset_Binding
    {
        ...
        static StackObject* get_asset_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            VEngine.Asset instance_of_this_method = (VEngine.Asset)typeof(VEngine.Asset).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Load_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = VEngine.Asset.Load(@path, @type);
        ...
        static StackObject* LoadAsync_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<VEngine.Asset> @completed = (System.Action<VEngine.Asset>)typeof(System.Action<VEngine.Asset>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
